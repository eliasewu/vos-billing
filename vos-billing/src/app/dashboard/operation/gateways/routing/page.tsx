...
import { ArrowLeftRight, Search, RefreshCw, Server, Shield, Wifi, Plus, Edit2, Trash2, X } from "lucide-react";
...
export default function RoutingGatewayPage() {
  ...
  const [form, setForm] = useState({ name:"", prefix:"", protocol:"0", lockType:0, capacity:0, priority:0, remoteIps:"", signalPort:5060, gatewayGroups:"", memo:"", encrypt:0, callLevel:0, clearingCustomerId:0 });
  ...
  const openAdd = () => {
    setEditingGw(null);
    setForm({ name:"", prefix:"", protocol:"0", lockType:0, capacity:0, priority:0, remoteIps:"", signalPort:5060, gatewayGroups:"", memo:"", encrypt:0, callLevel:0, clearingCustomerId:0 });
    setShowModal(true);
  };
  ...
  return (
    <div className="p-6 space-y-6">
      <div className="flex items-center justify-between">
        <div><h1 className="text-2xl font-bold text-surface-50">Routing Gateway</h1><p className="text-surface-400 text-sm mt-1">Supplier / Clearing gateway management</p></div>
