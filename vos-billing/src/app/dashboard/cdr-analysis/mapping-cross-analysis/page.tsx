...
export default function MappingCrossAnalysisPage() {
  ...
  const exportCSV = () => {
    ...
    const b = new Blob([csv], { type: "text/csv" }); const a = document.createElement("a"); a.href = URL.createObjectURL(b); a.download = "mapping_cross_analysis.csv"; a.click();
  };

  return (
    <div className="p-6 space-y-6">
      <div className="flex items-center justify-between">
        <div><h1 className="text-2xl font-bold text-surface-50">Mapping — Cross Analysis</h1><p className="text-surface-400 text-sm mt-1">Caller area → Callee area cross-reference</p></div>
